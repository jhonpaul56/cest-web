          ...
          {activeTab === "preferences" && (
            <div>
              ...
              {[
                ...
                >
                  <div>
                    <div style={{ fontSize: ".75rem", color: "#6c757d", textTransform: "uppercase" }}>
                      {lbl}
                    </div>
                    <div style={{ fontSize: ".93rem", fontWeight: 500, color: "#1e3a6e" }}>
                      {val}
                    </div>
                  </div>
                </div>
              ...
              <div style={{ padding: "12px 14px", borderRadius: 10, background: "#f4f7ff" }}>
                <div style={{ fontSize: ".75rem", color: "#6c757d", textTransform: "uppercase", marginBottom: 6 }}>
                  Theme
                </div>
                <select
                  value={theme}
          ...
          {activeTab === "notifications" && (
            <div>
              ...
              {[
                ...
                >
                  <div>
                    <div style={{ fontSize: ".9rem", fontWeight: 500, color: "#1e3a6e" }}>
                      {label}
                    </div>
...
function EditModal({ project, index, onClose, onSave }) {
  ...
  function set(key, val) {
    ...
    // Auto-calculate total when male/female changes
    if (key === "male" || key === "female") {
      updated.total =
        (parseInt(key === "male"   ? val : form.male)   || 0) +
          ...
          >
            <div>
              ...
              <input
                type="number"
                value={form.male}
                onChange={(e) => set("male", e.target.value)}
                style={inputStyle}
                placeholder="0"
                min="0"
              />
            ...
            <div>
              ...
              <input
                type="number"
                value={form.female}
                onChange={(e) => set("female", e.target.value)}
                style={inputStyle}
                placeholder="0"
                min="0"
              />
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              fontSize:     ".9rem",
              cursor:       "pointer",
              boxShadow:    "0 4px 14px rgba(30,91,184,0.35)",
            }}
          >
            ✅ Save Changes
          </button>
    ...
    >
      ...
      >
        ...
        <div style={{ padding: 24 }}>
          ...
          <p style={{ fontSize: ".83rem", color: "#6c757d", margin: 0 }}>
              ...
              >
                <div>
                  ...
                  <h3
                    style={{
                      margin:     0,
                      fontSize:   typeof val === "string" ? "1.1rem" : "1.8rem",
                      fontWeight: 700,
                    }}
                  >
                    {val}
                ...
                <tbody>
                  {filtered.length === 0 ? (
                    ...
                    filtered.map((p, i) => {
                      ...
                      const catStyle =
                        CAT_BADGE_COLORS[p.category] ||
                        { bg: "#e8f0ff", color: "#1e5bb8" };
                        ...
                        >
                          ...
                          <td style={{ padding: "11px 16px" }}>
                            <div style={{ display: "flex", gap: 8 }}>
                              ...
                              <button
                                onClick={() =>
                                  setEditTarget({ index: realIdx, project: p })
                                }
                                onMouseOver={(e) => {
                              ...
                              <button
                                onClick={() =>
                                  setDeleteTarget({ index: realIdx, project: p })
                                }
                                onMouseOver={(e) => {
                                  e.currentTarget.style.transform = "translateY(-1px)";
