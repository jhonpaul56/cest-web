...
function BarChart({ projects }) {
  ...
  const pad = 40;
  const gap = 8;
  const barW = projects.length
    ? Math.max(8, (W - pad * 2 - gap * (projects.length - 1)) / projects.length)
    : 40;
        ...
        <div style={{ padding: 22, overflowY: "auto" }}>
          ...
          <span
            style={{
              ...
              fontWeight: 600,
              marginBottom: 18,
              background: s === "Completed" ? "#d4f5e2" : "#e0f0ff",
              color: s === "Completed" ? "#1a6b3c" : "#1e5bb8",
            }}
          >
            {s === "Completed" ? "✅" : "🔵"} {s}
          </span>
              ...
              {alert && (
                <div
                  style={{
                    ...
                    color:
                      alert.type === "success" ? "#1a6b2e" : "#b02020",
                  }}
                >
                  {alert.msg}
                </div>
...
export default function CESTDashboard() {
  ...
  const [reminders, setReminders] = useState([
    { text: "Review Q1 Report", date: "2025-03-01", notified: false },
  ]);
  ...
  function addReminder() {
    ...
    setReminders([
      ...reminders,
      { text: reminderInput, date: reminderDate, notified: false },
    ]);
    setReminderInput("");
    setReminderDate("");
  }
  ...
  const statCards = [
    ...
    },
    {
      ...
      val: `${active} Active / ${done} Done`,
      icon: "📈",
      bg: "linear-gradient(135deg,#ff7a18,#ffb347)",
    },
  ];

  const ddFiltered = search
    ? projects.filter(
        (p) =>
    ...
    >
      ...
      >
        ...
        <div style={{ padding: "0 32px" }}>
          ...
          >
            {statCards.map(({ label, val, icon, bg }) => (
              ...
              >
                ...
                >
                  <div>
                    <p style={{ fontSize: ".8rem", opacity: 0.85, margin: "0 0 5px" }}>
                      {label}
                    </p>
                    <h3
                      style={{
                        margin: 0,
                        fontSize: typeof val === "string" ? "1rem" : "1.7rem",
                        fontWeight: 700,
                      }}
                    >
                      {val}
                ...
                >
                  {ddFiltered.length === 0 ? (
                    ...
                    <>
                      ...
                      >
                        🔍 {ddFiltered.length} result{ddFiltered.length > 1 ? "s" : ""} found
                      </div>
                      ...
                      {ddFiltered.map((p, i) => (
                        ...
                        >
                          ...
                          <div style={{ flex: 1 }}>
                            ...
                            <div style={{ fontSize: ".74rem", color: "#6c757d" }}>
                              {p.focal} • {p.address}
                            </div>
                          </div>
            ...
            >
              ...
              {catDDOpen && catFiltered.length > 0 && (
                ...
                >
                  ...
                  >
                    📂 {catFiltered.length} project{catFiltered.length > 1 ? "s" : ""} in this category
                  </div>
          ...
          {showCharts && (
            ...
            >
              ...
              >
                ...
                >
                  Income Growth by Community Sector (Bar)
                </h6>
          ...
          >
            <h6 style={{ fontWeight: 600, color: "#1e3a6e", marginBottom: 14 }}>
              {tableLabel}
            </h6>
              ...
              >
                <thead>
                  <tr style={{ background: "#1f1f20", color: "white" }}>
                    {["#", "Project Name", "Category", "Total Amount", "Action"].map(
                      (h) => (
                        <th
                          key={h}
                          style={{
                          ...
                          <td style={{ padding: "10px 14px" }}>
                            ...
                            <span
                              style={{
                                ...
                                fontWeight: 700,
                                background:
                                  s === "Completed" ? "#d4f5e2" : "#e0f0ff",
                                color:
                                  s === "Completed" ? "#1a6b3c" : "#1e5bb8",
                              }}
                            >
                              {s}
                            </span>
                          ...
                          <td style={{ padding: "10px 14px" }}>
                            <button
                              ...
                              style={{
                                ...
                                border: "none",
                                background:
                                  "linear-gradient(135deg,#1e5bb8,#4c84e0)",
                                color: "white",
                                fontWeight: 600,
                                fontSize: ".82rem",
                                cursor: "pointer",
