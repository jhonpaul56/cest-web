          ...
          >
            ...
            <div style={{ marginBottom: 18 }}>
              <label style={labelStyle}>
                LGU / Barangay / Community / Group / Association{" "}
                {errors.community && (
                  <span style={{ color: "#dc3545", fontWeight: 400 }}>
                    — {errors.community}
                  </span>
                )}
              </label>
                ...
                return (
                  <label
                    ...
                    style={{
                      ...
                      borderRadius: 10,
                      cursor: "pointer",
                      background: checked ? "#e8f0ff" : "#f4f7ff",
                      border: checked
                        ? "1.5px solid #1e5bb8"
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        height: 20,
                        borderRadius: 5,
                        border: `2px solid ${checked ? "#1e5bb8" : "#aab"}`,
                        background: checked ? "#1e5bb8" : "white",
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
                        flexShrink: 0,
            ...
            <div style={{ textAlign: "center" }}>
              <button
                ...
                style={{
                  ...
                  fontSize: "1rem",
                  cursor: "pointer",
                  boxShadow: "0 4px 14px rgba(30,91,184,0.4)",
